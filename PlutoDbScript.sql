...
/****** Object:  Database [Pluto]    Script Date: 25/01/2020 11:46:10 ******/
CREATE DATABASE [Pluto]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Pluto', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Pluto.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Pluto_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\Pluto_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Pluto] SET QUERY_STORE = OFF
GO
